...
it('缓存输入覆盖源码、两端构建路由、共享样式与工程配置并排除生成目录', () => {
  ...
  try {
    writeRepositoryFiles(root, {
      ...
      'packages/api/tmp/ignored.ts': 'export const ignored = true\n',
      'packages/shared-ui/src/styles/index.css': ':root { color: black; }\n',
      'pnpm-lock.yaml': 'lockfileVersion: 9\n',
      'pnpm-workspace.yaml': 'packages: []\n',
      'projects/admin/src/routeTree.gen.ts': 'export const generated = true\n',
      'projects/admin/src/router/index.tsx': 'export const router = true\n',
      ...
      'projects/client/src/router/index.tsx': 'export const router = true\n',
